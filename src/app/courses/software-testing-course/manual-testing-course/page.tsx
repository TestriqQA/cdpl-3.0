...
export const metadata: Metadata = generateMetadata({
  title: "Manual Testing Course in Mumbai | QA Training with Placement",
  description: "Master Manual Testing in 12 weeks — ISTQB prep, live projects, Jira & Agile. Online & classroom QA training in Mumbai with placement support. Enroll now!",
  keywords: [
