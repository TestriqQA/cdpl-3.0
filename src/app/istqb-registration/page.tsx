    ...
    return (
        <main className="min-h-screen bg-slate-50 relative font-sans">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 md:py-10">
                ...
                {/* Header Section (Only show on Step 1 & 2) */}
                {step !== 3 && (
                    <div className="text-left md:text-center max-w-3xl mx-auto mb-16">
                        ...
                        >
                            {step === 1 ? 'ISTQB Certification Registration' : 'Choose Your Next Step'}
                        </motion.h1>
                        ...
                        >
                            {step === 1
                                ? 'Join thousands of certified professionals. Register today to boost your career with globally recognized testing certifications.'
                                : `Great to have you on board, ${userData?.name?.split(' ')[0] || 'User'}! How would you like to proceed?`
                            }
                        </motion.p>
                    </div>
                )}
                ...
                {step === 1 && (
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                        ...
                        <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-24">
                            ...
                            >
                                <h3 className="text-xl font-bold text-slate-900 mb-6">Why Register With Us?</h3>
                                ...
                                <div className="mt-8 p-6 bg-white rounded-2xl shadow-sm border border-slate-100">
                                    <div className="flex items-center gap-4 mb-4">
                                        ...
                                        <div>
                                            <p className="font-bold text-slate-900">"Excellent Support"</p>
                                            <p className="text-sm text-slate-500">Rated 4.9/5 by 2000+ students</p>
                                        </div>
                                    </div>
                                    <p className="text-slate-600 italic text-sm">
                                        "The registration process was smooth, and the team helped me choose the right module for my experience level."
                                    </p>
                                </div>
                            </motion.div>
                        </div>
                        ...
                        <div className="lg:col-span-7 order-1 lg:order-2">
                                ...
                                <div className="space-y-6">
                                    ...
                                    >
                                        <div className="p-8 md:p-10 text-center md:text-left">
                                            <div className="inline-flex items-center justify-center w-16 h-16 bg-green-100 text-green-600 rounded-full mb-6 mx-auto md:mx-0">
                            ...
                            {choice === 'booking' && (
                                <div className="space-y-6">
                                    ...
                                    <BookingOption userData={userData} onSuccess={handleBookingSuccess} />
                                </div>
                            )}
                            ...
                            {choice === 'exam' && (
                                <div className="space-y-6">
                                    ...
                                    <ExamSelection userData={userData} onSuccess={handleFinalSuccess} />
                                </div>
                            )}
                        </div>
                    </div>
