...
const RegistrationModal = dynamic(() => import("@/components/mock-test/RegistrationModal"), { ssr: false });
import type { RegistrationData } from "@/components/mock-test/RegistrationModal";
...
export default function MockTestListing() {
