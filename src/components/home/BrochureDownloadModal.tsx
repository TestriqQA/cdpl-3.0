...
const BrochureDownloadModal: React.FC<BrochureDownloadModalProps> = ({ isOpen, onClose, source }) => {
  ...
  return createPortal(
    <>
      ...
      {isOpen && (
          <div
            className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm px-4 cdpl-animate-fade-in"
            onClick={handleClose}
          >
            <div
            ...
            >
              ...
              <div className="p-6">
                {isSubmitted ? (
                  <div
                    className="text-center py-8 cdpl-animate-fade-in"
                  >
