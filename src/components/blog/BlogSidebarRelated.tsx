        ...
        {isSubscribed ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-3" ref={formRef}>
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-orange-500 to-amber-500 hover:from-brand hover:to-amber-600 text-white font-semibold py-2.5 px-4 rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 text-sm cursor-pointer"
              >
                Subscribe Now
              </button>
            </form>
