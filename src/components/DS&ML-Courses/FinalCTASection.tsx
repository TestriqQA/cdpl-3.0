...
const FinalCTASection: React.FC<CTASectionProps> = () => {
        ...
        try {
            const response = await fetch('/api/contact', {
                ...
                body: JSON.stringify({
                    ...
                    source: 'Data Science & Machine Learning Course Category Page - Final CTA Section - Right Form',
                }),
            });
    ...
    return (
        ...
        >
            ...
            <BrochureDownloadModal isOpen={isBrochureOpen} onClose={() => setIsBrochureOpen(false)} source="Data Science & Machine Learning Course Category Page - Final CTA Section - Download Brochure" />
        </section>
    );
};
