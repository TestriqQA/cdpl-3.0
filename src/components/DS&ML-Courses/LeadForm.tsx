            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5 w-full overflow-hidden">
                ...
                {showCourse && (
                    ...
                    >
                        ...
                        <option>Machine Learning and Data Science with Python - Hero Program</option>
                        <option>Deep Learning, NLP and Generative AI</option>
                        <option>Advanced Data Science and Machine Learning Masterclass</option>
                        <option>Comprehensive Data Science and AI - Master Program</option>
                        <option>Machine Learning Algorithms using python Programming</option>
                        <option>Machine Learning and Data Visualization using R Programming</option>
