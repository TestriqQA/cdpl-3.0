                ...
                <div className="max-w-5xl">
                    ...
                    <div className="mt-6 flex items-center gap-3">
                        <button
                            ...
                            className="inline-flex items-center gap-2 px-5 py-4 bg-brand text-white rounded-lg text-md font-semibold shadow hover:translate-y-[-1px] transition-transform"
                        >
...
export default function HeroSection(): React.JSX.Element {
    ...
    return (
        <section className="relative bg-white py-10 overflow-hidden">
            <EnrollPopup isOpen={isEnrollOpen} onClose={() => setIsEnrollOpen(false)} onSubmit={() => { }} source="Software Testing Course Category Page - Hero Section - Enroll Now" />
            <BrochureDownloadModal isOpen={isBrochureOpen} onClose={() => setIsBrochureOpen(false)} source="Software Testing Course Category Page - Hero Section - Download Brochure" />
                    ...
                    <div className="my-8">
                        <div className="bg-white p-5 rounded-xl shadow-lg border border-slate-100">
                            <LeadForm
                                ...
                                showCourse={false}
                                source="Software Testing Course Category Page - Hero Section - Mobile Form"
                            />
                        </div>
                    </div>
