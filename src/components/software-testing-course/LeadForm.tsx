            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 sm:space-y-5 w-full overflow-hidden">
                <div className="w-full overflow-hidden">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ff8c00] overflow-hidden"
                    />
                ...
                <div className="phone-input-wrapper w-full px-3 py-2.5 sm:py-3 border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-[#ff8c00] bg-white overflow-hidden">
                ...
                {showCourse && (
                    <select
                        ...
                        className="w-full px-4 py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ff8c00] bg-white overflow-hidden"
                    >
