      ...
      <div className="container mx-auto px-4">
        <header className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-base md:text-lg leading-relaxed text-slate-700">
            Enroll now to get <strong>100% job assistance</strong>,{" "}
            <strong>4 global certificates</strong>, and a portfolio recruiters love —
            built with <strong>Python, SQL, Machine Learning,</strong> and{" "}
        ...
        >
          <li className="rounded-xl border border-emerald-200 bg-emerald-50 p-3 text-center">
            <span className="text-xs font-semibold uppercase tracking-wide text-emerald-700">
              Job Assistance
            </span>
            <div className="mt-1 text-sm text-slate-800">Resume, mock interviews, referrals</div>
          </li>
          <li className="rounded-xl border border-sky-200 bg-sky-50 p-3 text-center">
            <span className="text-xs font-semibold uppercase tracking-wide text-sky-700">
              Global Certificates
            </span>
            <div className="mt-1 text-sm text-slate-800">4 verifiable credentials</div>
          </li>
          <li className="rounded-xl border border-amber-200 bg-amber-50 p-3 text-center">
            <span className="text-xs font-semibold uppercase tracking-wide text-amber-700">
              Project Portfolio
            </span>
            <div className="mt-1 text-sm text-slate-800">GitHub + live demos</div>
          </li>
        </ul>
        ...
        <p className="mx-auto mt-4 max-w-3xl text-center text-xs sm:text-sm text-slate-600">
          ...
          <span className="font-semibold text-slate-800">
            Limited cohorts, mentor-led, flexible schedules.
          </span>
        </p>
