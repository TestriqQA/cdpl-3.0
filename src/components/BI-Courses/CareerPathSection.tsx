...
import { careerPathContent } from "@/components/BI-Courses/data/data";
            ...
            >
                ...
                <div className="p-8 flex flex-col flex-grow">
                    ...
                    <div className="mt-auto flex flex-col gap-3 text-center">
                        ...
                        <Link 
                            href="/jobs/live-jobs" 
                            title="View All Live Job Openings"
...
export default function CareerPathSection() {
    ...
    return (
        <section className="relative py-10 bg-gradient-to-b from-white via-gray-50 to-white overflow-hidden">
            <EnrollPopup isOpen={isEnrollOpen} onClose={() => setIsEnrollOpen(false)} onSubmit={handleEnrollSubmit} source="Business Intelligence Course Category Page - Career Section - Enroll Now" />
            ...
            <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                    {(careerPathContent.paths as Partial<CareerPath>[]).map((p, index) => {
                        ...
                        return <CareerCard key={`${full.id}-${full.role}-${index}`} path={full} index={index} onEnroll={() => setIsEnrollOpen(true)} />;
                    })}
                </div>
                ...
                <BrochureDownloadModal isOpen={isBrochureOpen} onClose={() => setIsBrochureOpen(false)} source="Business Intelligence Course Category Page - Career Section - Download Career Guide" />
            </div>
