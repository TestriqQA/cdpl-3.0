    ...
    >
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {ROLES.map((r, i) => (
            ...
            >
              ...
              <EnrollButton
                source={`Java Programming Course Page - Career Section - Apply for ${r.title}`}
        ...
        <div className="mx-auto mt-8 flex max-w-3xl flex-col items-center justify-center gap-3 text-center sm:flex-row sm:gap-4">
          ...
          <EnrollButton
            source="Java Programming Course Page - Career Section - Download Resume Template"
            courseName="Java Programming"
