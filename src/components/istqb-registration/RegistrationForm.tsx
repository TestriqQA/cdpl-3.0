...
import { User, Mail, Phone, MapPin, Briefcase, Award, ArrowRight, Loader2 } from 'lucide-react';
...
export default function RegistrationForm({ onSuccess }: RegistrationFormProps) {
    ...
    return (
        <motion.div
            ...
            className="bg-white rounded-3xl shadow-xl border border-slate-100 py-8 px-6 md:p-10 relative"
        >
            {/* Decor */}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2 relative z-50">
                        <label htmlFor="certificationLevel" className="text-sm font-semibold text-slate-700 ml-1">ISTQB Certification Level</label>

                        {/* Hidden input for formData */}
                        <input type="hidden" name="certificationLevel" value={selectedLevel} />
                        ...
                        <div className="relative">
                            ...
                            {/* Dropdown Menu */}
                            {isOpen && (
                                <div className="absolute mt-2 w-full bg-white rounded-xl shadow-xl border border-slate-100 max-h-80 overflow-y-auto z-50 py-2">
