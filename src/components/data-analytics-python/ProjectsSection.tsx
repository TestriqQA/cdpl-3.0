            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-16 md:mb-20">
                    <h2 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">
                        Real-Time <span className="text-[#d04502]">Projects</span>
                    </h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
                    {projects.map((project, idx) => (
                        ...
                        >
                            {/* Icon */}
                            <div className="mb-4 inline-flex items-center justify-center w-14 h-14 rounded-lg bg-white/60 text-[#d04502]">
                                {project.icon}
                            </div>

                            {/* Domain Badge */}
                            <div className="mb-3">
                                <span className="text-xs font-bold text-[#d04502] bg-orange-100/60 px-3 py-1 rounded-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        >
                            <div className="text-[#d04502] mb-3">{benefit.icon}</div>
