    ...
    <section id="faq" aria-labelledby="faq-heading" className="relative py-10 bg-white">
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto -mt-2 mb-6 max-w-2xl text-center text-sm sm:text-base text-slate-600">
          Can’t find an answer? <Link href="/contact-us" title="Contact our team for personalized guidance" className="font-medium text-sky-700 hover:underline">Contact our team</Link> for personalized guidance.
        </p>
