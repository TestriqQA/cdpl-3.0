...
const VARIANTS: Variant[] = [
    ...
    {
        header:
            "bg-gradient-to-br from-rose-600 via-pink-600 to-orange-700 text-white",
        button: "bg-gradient-to-r from-rose-600 to-orange-700",
...
const CourseCard: React.FC<{ course: Course; index: number; nowMs: number }> = ({ course, index, nowMs }) => {
    ...
    return (
        ...
        >
            <EnrollPopup isOpen={isEnrollOpen} onClose={() => setIsEnrollOpen(false)} onSubmit={(data) => console.log(data)} source={`Digital Marketing Course Category Page - Courses Section - ${course.title} - Enroll Now`} />
            ...
            <div className="p-6 flex-grow flex flex-col space-y-4">
                ...
                <div className="pt-4 space-y-3 mt-auto">
                    ...
                    <DownloadFormButton
                        ...
                        source={`Digital Marketing Course Category Page - Courses Section - ${course.title} - Download Syllabus`}
                    />
                </div>
            </div>
