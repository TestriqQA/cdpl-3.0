...
function Pill({ children }: { children: React.ReactNode }) {
  return (
    <span className="rounded-full border border-orange-200 bg-orange-50 px-2.5 py-1 text-xs font-semibold text-brand">
      {children}
    </span>
  );
}
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-2">
                {techFromText.map((t) => (
                  <span
                    key={t}
                    className="rounded-full border border-orange-200 bg-orange-50 px-2.5 py-1 text-xs font-semibold text-brand"
                  >
                    {t}
                  </span>
                ))}
