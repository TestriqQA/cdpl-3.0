  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (isFullNameValid && isEmailValid && isPhoneValid) {
      ...
      try {
        ...
        if (response.ok) {
          console.log('Syllabus request submitted successfully');
          setIsSubmitted(true);
              ...
              <div className="bg-gradient-to-r from-indigo-600 to-indigo-700 px-6 py-5 relative">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/90 mt-0.5">Get instant access to {courseName} syllabus</p>
                  </div>
                </div>
              </div>
