                ...
                <div className="p-8 flex flex-col flex-grow">
                    <div className="flex items-start justify-between mb-6">
                        ...
                        <div className="flex flex-col gap-2 items-end hidden md:block">
                            {path.trending && (
                                <span className="flex items-center gap-1 text-xs font-bold px-3 py-1 bg-orange-50 text-brand border border-orange-200 rounded-full">
                    ...
                    <div className="mt-auto flex flex-col gap-3 text-center">
                        ...
                        <Link href="/jobs/live-jobs" title="View Job Openings" className="w-full text-gray-600 font-semibold py-3 rounded-xl border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 transition-all duration-300">
                            View Job Openings
                        </Link>
                    </div>
