...
| **Founder** | `Sandeep Maske` — LinkedIn `https://www.linkedin.com/in/sandeepmaske/` (user-confirmed 2026-05-22) | ✅ **Q5 resolved.** Organization JSON-LD emits `founder: { @type: Person, name: "Sandeep Maske", jobTitle: "Founder", sameAs: ["https://www.linkedin.com/in/sandeepmaske/"] }` — shipped in `fix/blg-064-founder-sameas`, merged to `develop`. |
